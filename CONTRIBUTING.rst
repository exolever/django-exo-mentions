...
The best way to send feedback is to file an issue at https://github.com/marfyl/django-mentions/issues.
...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:your_name_here/django-mentions.git
...
3. The pull request should work for Python 2.6, 2.7, and 3.3, and for PyPy. Check 
   https://travis-ci.org/marfyl/django-mentions/pull_requests
